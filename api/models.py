...
class UserWallet(models.Model):
	user = models.ForeignKey(User, on_delete=models.CASCADE)
	available_balance = models.DecimalField(default=0.00, max_digits=1000000, decimal_places=2)
	total_balance = models.DecimalField(default=0.00, max_digits=1000000, decimal_places=2)
