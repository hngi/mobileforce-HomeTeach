...
//        val endRequestDateTime = dateFormat.parse(element.day + " " + element.to_hour + ":" + element.to_minute)!!.time
        with(element) {
            ...
            binding.classProgressBar.progress =
                0 //(currentDateTime/endRequestDateTime).toInt() * 100
            binding.classProgressText.text =
                binding.classProgressBar.progress.toString() + "%" + "\ndone"
