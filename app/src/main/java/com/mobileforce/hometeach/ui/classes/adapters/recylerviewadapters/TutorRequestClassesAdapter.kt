...
import com.mobileforce.hometeach.databinding.ListItemClassRequestsTutorBinding
...
class TutorRequestClassesAdapter :
    ListAdapter<RequestClassModel, TutorRequestClassesAdapter.ViewHolder>(
    ...
    class ViewHolder(private val binding: ListItemClassRequestsTutorBinding) :
        ...
        companion object {
            fun from(parent: ViewGroup): ViewHolder {
                ...
                val binding =
                    ListItemClassRequestsTutorBinding.inflate(layoutInflater, parent, false)
                return ViewHolder(
                    binding
                )
            }
